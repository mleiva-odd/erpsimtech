    ...
    <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md">
        ...
        <div className="p-6 space-y-4">
          <div>
            <label className="block text-[10px] font-bold text-slate-400 mb-1.5 uppercase">Nombre</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-[10px] font-bold text-slate-400 mb-1.5 uppercase">Base</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-slate-400 mb-1.5 uppercase">Tasa (0..1)</label>
          ...
          <div>
            <label className="block text-[10px] font-bold text-slate-400 mb-1.5 uppercase">Categoría (opcional)</label>
